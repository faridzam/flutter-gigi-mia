...
import 'package:gigi_mia/models/PemeriksaanModel.dart';
import 'package:gigi_mia/databaseHandlers/DBHelperPemeriksaan.dart';
...
class _PemeriksaanScreenState extends State<PemeriksaanScreen> {
  ...
  final _conKelainan = TextEditingController();
  ...
  submit() async {
    ...
    String kelainan = _conKelainan.text;
    ...
    if (form.validate()) {
      if (nama == "null") {
        ...
        PemeriksaanModel uModel = PemeriksaanModel(user_id, nama, usia, jeniskelamin, kelainan);
        await dbHelper.saveDataPemeriksaan(uModel).then((lansiaData) {
          Fluttertoast.showToast(
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: Column(children: [
                            ...
                            TextFormField(
                              controller: _conKelainan,
                              style: TextStyle(color: Colors.black),
                              keyboardType: TextInputType.text,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return "Masukkan Kelainan Gigi Lansia";
                                } else if (value.length < 1) {
                                  return "error";
                                }
                                return null;
